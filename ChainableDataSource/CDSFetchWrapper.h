...
/**
 This data source object turns an NSFetchedResultsController into a chainable data source, 
 forwarding the updates to its delegate
 */
@interface CDSFetchWrapper : NSObject <CDSDataSource>
