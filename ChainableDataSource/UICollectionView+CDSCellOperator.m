//
//  UICollectionView+CDSCellOperator.m
//  ChainableDataSource
//
...
#import "UICollectionView+CDSCellOperator.h"

@implementation UICollectionView (CDSCellOperator)
...
- (NSIndexPath*) cds_indexPathForCell:(UIView*)cell
{
    if ([cell isKindOfClass:[UICollectionViewCell class]]) {
        return [self indexPathForCell:(UICollectionViewCell*)cell];
    } else {
        return nil;
    }
}
